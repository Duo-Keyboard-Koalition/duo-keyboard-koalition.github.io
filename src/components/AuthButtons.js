    ...
    <div className="flex flex-col space-y-6 items-center">
      ...
      <div className="flex flex-col space-y-4 items-center w-full">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-gray-800 px-4 py-2 rounded-md w-full max-w-[240px] text-sm font-medium transition-colors"
        >
        ...
        <div id="google-signin" className="hidden"></div>
      </div>
    </div>
  )
}
